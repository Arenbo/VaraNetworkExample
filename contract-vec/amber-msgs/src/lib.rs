...
// 1. Pushes the first message to the global 'MESSAGES' vec.
...
// 2. Pushing new value to the global 'MESSAGES' vec.
...
// 1. Sends all messages stored in the global 'MESSAGES' vec as a reply.
#[no_mangle]
extern "C" fn state() {
